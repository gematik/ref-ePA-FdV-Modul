...
import de.gematik.ti.epa.fdv.key.access.gen.invoker.auth.ApiKeyAuth;
import de.gematik.ti.epa.fdv.key.access.gen.invoker.auth.Authentication;
import de.gematik.ti.epa.fdv.key.access.gen.invoker.auth.HttpBasicAuth;
import okhttp3.*;
...
public class ApiClient {
    ...
    private String basePath = "https://gltu1103.mgm1.telematik-test:9094";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://gltu1119.mgm1.telematik-test:9099/#
     ...
     * @return String representation of the parameter
     */
    public String collectionPathParameterToString(final String collectionFormat, final Collection value) {
     ...
     */
    public Call buildCall(final String path, final String method, final List<Pair> queryParams, final List<Pair> collectionQueryParams, final Object body,
            final Map<String, String> headerParams,
            final Map<String, Object> formParams, final String[] authNames, final ApiCallback callback) throws ApiException {
        final Request request = buildRequest(path, method, queryParams, collectionQueryParams, body, headerParams, formParams, authNames, callback);
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public Request buildRequest(final String path, final String method, final List<Pair> queryParams, final List<Pair> collectionQueryParams, final Object body,
            final Map<String, String> headerParams, final Map<String, Object> formParams, final String[] authNames, final ApiCallback callback)
            throws ApiException {
     ...
     * @return The full URL
     */
    public String buildUrl(final String path, final List<Pair> queryParams, final List<Pair> collectionQueryParams) {
    ...
    public RequestBody buildRequestBodyMultipart(final Map<String, Object> formParams) {
        ...
        for (final Entry<String, Object> param : formParams.entrySet()) {
            if (param.getValue() instanceof File) {
                ...
                final Headers partHeaders = Headers.of("Content-Disposition",
                ...
                final Headers partHeaders = Headers.of("Content-Disposition", "form-data; name=\"" + param.getKey() + "\"");
    ...
    private void applySslSettings() {
        try {
            ...
            if (!verifyingSsl) {
                ...
                final Collection<? extends Certificate> certificates = certificateFactory.generateCertificates(sslCaCert);
