...
*/
public class RequestSecurityTokenType extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
...
if (inObj.hasAttribute("Context"))
        {	
            java.lang.Object j = inObj.getAttribute("Context");
            if (j != null)
            {
                Context = j.toString();
            }
