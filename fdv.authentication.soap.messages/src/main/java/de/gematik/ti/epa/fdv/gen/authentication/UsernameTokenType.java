...
*/
public class UsernameTokenType extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Username"))
        {
            if(obj!=null)
            {
                ...
                this.Username = (AttributedString)__envelope.get(j,AttributedString.class,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==0)
        {
            return this.Username!=null?this.Username.getSimpleValue():null;
        }
