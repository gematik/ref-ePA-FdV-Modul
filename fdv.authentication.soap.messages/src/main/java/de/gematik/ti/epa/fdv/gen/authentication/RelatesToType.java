...
if (inObj.hasAttribute("RelationshipType"))
        {	
            java.lang.Object j = inObj.getAttribute("RelationshipType");
            if (j != null)
            {
                RelationshipType = j.toString();
            }
        }
    ...
    public Object getSimpleValue()
    {
        ...
        if (this.RelationshipType != null)
        {
            ...
            attrInfo.setName("RelationshipType");
            attrInfo.setValue(this.RelationshipType);
