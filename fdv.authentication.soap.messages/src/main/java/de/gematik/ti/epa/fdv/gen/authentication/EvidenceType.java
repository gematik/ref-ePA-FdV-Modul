...
public class EvidenceType extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
...
if(this.EncryptedAssertion==null)
    ...
    public int getPropertyCount() {
        return 0+AssertionIDRef.size()+AssertionURIRef.size()+Assertion.size()+EncryptedAssertion.size();
    }
