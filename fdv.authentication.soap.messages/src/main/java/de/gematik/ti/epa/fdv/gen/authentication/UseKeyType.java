...
public class UseKeyType extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
...
if (inObj.hasAttribute("Sig"))
        {	
            java.lang.Object j = inObj.getAttribute("Sig");
            if (j != null)
            {
                Sig = j.toString();
            }
