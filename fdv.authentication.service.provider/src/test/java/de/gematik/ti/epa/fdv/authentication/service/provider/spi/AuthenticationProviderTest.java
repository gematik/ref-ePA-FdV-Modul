...
package de.gematik.ti.epa.fdv.authentication.service.provider.spi;
...
public class AuthenticationProviderTest {
    ...
    public void testGetCard() {
        Assert.assertThat(new AuthenticationResult(AuthenticationState.AUTH_SUCCEED, new byte[] {}).getRawSignData(), IsNull.nullValue());
    }
}
