...
public class GetAuthorizationKey extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
    
    public RecordIdentifierType RecordIdentifier;
    
	/**
	* Gerätekennung des Geräts des Versicherten, Verwendung nur bei Aufruf aus der Personal Zone des Versicherten
	*/
