...
public class IVL_REAL extends SXCM_REAL implements KvmSerializable,java.io.Serializable
{
    
	/**
	* The low limit of the interval.
	*/
    public IVXB_REAL low;
	...
	*/
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("low"))
        {
            if(obj!=null)
            {
                ...
                this.low = (IVXB_REAL)__envelope.get(j,IVXB_REAL.class,false);
            }
            return true;
        }
        if (info.name.equals("width"))
        {
            if(obj!=null)
            {
                ...
                {
                    java.lang.Object j=obj;
                    this.width = (REAL)__envelope.get(j,REAL.class,false);
                }
                if(i0 == 1)
                {
                    java.lang.Object j=obj;
                    this.width_1 = (REAL)__envelope.get(j,REAL.class,false);
                }
                if(i0 == 2)
                {
                    java.lang.Object j=obj;
                    this.width_2 = (REAL)__envelope.get(j,REAL.class,false);
                }
            }
        }
        if (info.name.equals("high"))
        {
            if(obj!=null)
            {
                ...
                {
                    java.lang.Object j=obj;
                    this.high = (IVXB_REAL)__envelope.get(j,IVXB_REAL.class,false);
                }
                if(i0 == 1)
                {
                    java.lang.Object j=obj;
                    this.high_1 = (IVXB_REAL)__envelope.get(j,IVXB_REAL.class,false);
                }
                if(i0 == 2)
                {
                    java.lang.Object j=obj;
                    this.high_2 = (IVXB_REAL)__envelope.get(j,IVXB_REAL.class,false);
                }
            }
        }
        if (info.name.equals("center"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.center = (REAL)__envelope.get(j,REAL.class,false);
            }
            return true;
        }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==count+0)
        {
            info.type = IVXB_REAL.class;
            info.name = "low";
            info.namespace= "urn:hl7-org:v3";
        }
        if(propertyIndex==count+1)
        {
            info.type = REAL.class;
            info.name = "width";
            info.namespace= "urn:hl7-org:v3";
        }
        if(propertyIndex==count+2)
