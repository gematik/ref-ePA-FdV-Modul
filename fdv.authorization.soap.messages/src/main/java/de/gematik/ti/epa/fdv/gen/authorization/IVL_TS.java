...
public class IVL_TS extends SXCM_TS implements KvmSerializable,java.io.Serializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("low"))
        {
            if(obj!=null)
            {
                ...
                this.low = (IVXB_TS)__envelope.get(j,IVXB_TS.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("high"))
        {
            if(obj!=null)
            {
                ...
                {
                    java.lang.Object j=obj;
                    this.high = (IVXB_TS)__envelope.get(j,IVXB_TS.class,false);
                }
                if(i0 == 1)
                {
                    java.lang.Object j=obj;
                    this.high_1 = (IVXB_TS)__envelope.get(j,IVXB_TS.class,false);
                }
                if(i0 == 2)
                {
                    java.lang.Object j=obj;
                    this.high_2 = (IVXB_TS)__envelope.get(j,IVXB_TS.class,false);
                }
            }
        }
        if (info.name.equals("center"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.center = (TS)__envelope.get(j,TS.class,false);
            }
            return true;
        }
