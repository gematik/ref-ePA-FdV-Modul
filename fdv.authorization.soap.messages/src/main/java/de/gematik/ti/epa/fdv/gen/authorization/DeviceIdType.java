...
public class DeviceIdType extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
...
if (inObj.hasAttribute("DisplayName"))
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Device"))
        {
            if(obj!=null)
            {
                ...
                this.Device = Helper.getBinary(j,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==0)
        {
            return this.Device!=null?org.kobjects.base64.Base64.encode((byte[])this.Device):SoapPrimitive.NullSkip;
        }
        return null;
    }
