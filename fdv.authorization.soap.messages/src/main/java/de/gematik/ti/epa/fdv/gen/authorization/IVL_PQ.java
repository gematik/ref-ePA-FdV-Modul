...
public class IVL_PQ extends SXCM_PQ implements KvmSerializable,java.io.Serializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("low"))
        {
            if(obj!=null)
            {
                ...
                this.low = (IVXB_PQ)__envelope.get(j,IVXB_PQ.class,false);
            }
            return true;
        }
        if (info.name.equals("width"))
        {
            if(obj!=null)
            {
                ...
                {
                    java.lang.Object j=obj;
                    this.width = (PQ)__envelope.get(j,PQ.class,false);
                }
                if(i0 == 1)
                {
                    java.lang.Object j=obj;
                    this.width_1 = (PQ)__envelope.get(j,PQ.class,false);
                }
                if(i0 == 2)
                {
                    java.lang.Object j=obj;
                    this.width_2 = (PQ)__envelope.get(j,PQ.class,false);
                }
            }
        }
        if (info.name.equals("high"))
        {
            if(obj!=null)
            {
                ...
                {
                    java.lang.Object j=obj;
                    this.high = (IVXB_PQ)__envelope.get(j,IVXB_PQ.class,false);
                }
                if(i0 == 1)
                {
                    java.lang.Object j=obj;
                    this.high_1 = (IVXB_PQ)__envelope.get(j,IVXB_PQ.class,false);
                }
                if(i0 == 2)
                {
                    java.lang.Object j=obj;
                    this.high_2 = (IVXB_PQ)__envelope.get(j,IVXB_PQ.class,false);
                }
            }
        }
        if (info.name.equals("center"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.center = (PQ)__envelope.get(j,PQ.class,false);
            }
            return true;
        }
