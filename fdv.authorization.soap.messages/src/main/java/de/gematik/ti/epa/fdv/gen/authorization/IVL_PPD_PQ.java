...
public class IVL_PPD_PQ extends SXCM_PPD_PQ implements KvmSerializable,java.io.Serializable
{
    
	/**
	* The low limit of the interval.
	*/
    public IVXB_PPD_PQ low;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("low"))
        {
            if(obj!=null)
            {
                ...
                this.low = (IVXB_PPD_PQ)__envelope.get(j,IVXB_PPD_PQ.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("high"))
        {
            if(obj!=null)
            {
                ...
                {
                    java.lang.Object j=obj;
                    this.high = (IVXB_PPD_PQ)__envelope.get(j,IVXB_PPD_PQ.class,false);
                }
                if(i0 == 1)
                {
                    java.lang.Object j=obj;
                    this.high_1 = (IVXB_PPD_PQ)__envelope.get(j,IVXB_PPD_PQ.class,false);
                }
                if(i0 == 2)
                {
                    java.lang.Object j=obj;
                    this.high_2 = (IVXB_PPD_PQ)__envelope.get(j,IVXB_PPD_PQ.class,false);
                }
            }
        }
        if (info.name.equals("center"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.center = (PPD_PQ)__envelope.get(j,PPD_PQ.class,false);
            }
            return true;
        }
