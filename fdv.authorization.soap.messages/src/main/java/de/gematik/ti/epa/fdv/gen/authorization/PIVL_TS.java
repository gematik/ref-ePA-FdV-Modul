...
*/
public class PIVL_TS extends SXCM_TS implements KvmSerializable,java.io.Serializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("phase"))
        {
            if(obj!=null)
            {
                ...
                this.phase = (IVL_TS)__envelope.get(j,IVL_TS.class,false);
            }
            return true;
        }
        if (info.name.equals("period"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.period = (PQ)__envelope.get(j,PQ.class,false);
            }
            return true;
        }
