...
public class UVP_TS extends TS implements KvmSerializable,java.io.Serializable
{
...
if (inObj.hasAttribute("probability"))
        {	
            java.lang.Object j = inObj.getAttribute("probability");
            if (j != null)
            {
                probability = new Double(j.toString());
            }
        }
    ...
    public void getAttributeInfo(int index, AttributeInfo info) {
        ...
        if(index==count+0)
                {
                info.name = "probability";
                info.namespace= "";
                if(this.probability!=null)
                {
                    info.setValue(this.probability);
                }
