...
public class PutNotificationInfo extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
    ...
    public String NewNotificationInfo;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("NewNotificationInfo"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.NewNotificationInfo = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.NewNotificationInfo = (String)obj;
                }
            }
            return true;
        }
