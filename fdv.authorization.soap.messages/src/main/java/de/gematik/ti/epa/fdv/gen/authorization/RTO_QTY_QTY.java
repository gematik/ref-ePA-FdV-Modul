...
public class RTO_QTY_QTY extends QTY implements KvmSerializable,java.io.Serializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("numerator"))
        {
            if(obj!=null)
            {
                ...
                this.numerator = (QTY)__envelope.get(j,QTY.class,false);
            }
            return true;
        }
        if (info.name.equals("denominator"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.denominator = (QTY)__envelope.get(j,QTY.class,false);
            }
            return true;
        }
