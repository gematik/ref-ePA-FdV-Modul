...
public class IVL_PPD_TS extends SXCM_PPD_TS implements KvmSerializable,java.io.Serializable
{
    
	/**
	* The low limit of the interval.
	*/
    public IVXB_PPD_TS low;
	...
	*                            to be stated and the third can be derived.
	*/
    public PPD_PQ width_1;
    
	/**
	* The high limit of the interval.
	*/
    public IVXB_PPD_TS high_2;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("low"))
        {
            if(obj!=null)
            {
                ...
                this.low = (IVXB_PPD_TS)__envelope.get(j,IVXB_PPD_TS.class,false);
            }
            return true;
        }
        if (info.name.equals("width"))
        {
            if(obj!=null)
            {
                ...
                {
                    java.lang.Object j=obj;
                    this.width = (PPD_PQ)__envelope.get(j,PPD_PQ.class,false);
                }
                if(i0 == 1)
                {
                    java.lang.Object j=obj;
                    this.width_1 = (PPD_PQ)__envelope.get(j,PPD_PQ.class,false);
                }
                if(i0 == 2)
                {
                    java.lang.Object j=obj;
                    this.width_2 = (PPD_PQ)__envelope.get(j,PPD_PQ.class,false);
                }
            }
        }
        if (info.name.equals("high"))
        {
            if(obj!=null)
            {
                ...
                {
                    java.lang.Object j=obj;
                    this.high = (IVXB_PPD_TS)__envelope.get(j,IVXB_PPD_TS.class,false);
                }
                if(i0 == 1)
                {
                    java.lang.Object j=obj;
                    this.high_1 = (IVXB_PPD_TS)__envelope.get(j,IVXB_PPD_TS.class,false);
                }
                if(i0 == 2)
                {
                    java.lang.Object j=obj;
                    this.high_2 = (IVXB_PPD_TS)__envelope.get(j,IVXB_PPD_TS.class,false);
                }
            }
        }
        if (info.name.equals("center"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.center = (PPD_TS)__envelope.get(j,PPD_TS.class,false);
            }
            return true;
        }
