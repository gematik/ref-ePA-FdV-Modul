...
public class I_AuthorizationBinding
{
    ...
    public I_AuthorizationBinding(){}

    public I_AuthorizationBinding(String url)
    {
        this.url = url;
    }

    public I_AuthorizationBinding(String url,int timeOut)
    {
        this.url = url;
    ...
    public GetAuthorizationKeyResponse GetAuthorizationKey(final RecordIdentifierType RecordIdentifier,final DeviceIdType DeviceID ) throws java.lang.Exception
    {
        ...
        },"http://ws.gematik.de/fd/phrs/AuthorizationService/v1.0#GetAuthorizationKey",__profile);
    }
