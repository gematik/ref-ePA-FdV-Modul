...
public class IVL_MO extends SXCM_MO implements KvmSerializable,java.io.Serializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("low"))
        {
            if(obj!=null)
            {
                ...
                this.low = (IVXB_MO)__envelope.get(j,IVXB_MO.class,false);
            }
            return true;
        }
        if (info.name.equals("width"))
        {
            if(obj!=null)
            {
                ...
                {
                    java.lang.Object j=obj;
                    this.width = (MO)__envelope.get(j,MO.class,false);
                }
                if(i0 == 1)
                {
                    java.lang.Object j=obj;
                    this.width_1 = (MO)__envelope.get(j,MO.class,false);
                }
                if(i0 == 2)
                {
                    java.lang.Object j=obj;
                    this.width_2 = (MO)__envelope.get(j,MO.class,false);
                }
            }
        }
        if (info.name.equals("high"))
        {
            if(obj!=null)
            {
                ...
                {
                    java.lang.Object j=obj;
                    this.high = (IVXB_MO)__envelope.get(j,IVXB_MO.class,false);
                }
                if(i0 == 1)
                {
                    java.lang.Object j=obj;
                    this.high_1 = (IVXB_MO)__envelope.get(j,IVXB_MO.class,false);
                }
                if(i0 == 2)
                {
                    java.lang.Object j=obj;
                    this.high_2 = (IVXB_MO)__envelope.get(j,IVXB_MO.class,false);
                }
            }
        }
        if (info.name.equals("center"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.center = (MO)__envelope.get(j,MO.class,false);
            }
            return true;
        }
