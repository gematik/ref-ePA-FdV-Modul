...
public class CipherReferenceType extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
    
    public TransformsType_1 Transforms;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Transforms"))
        {
            if(obj!=null)
            {
                ...
                this.Transforms = (TransformsType_1)__envelope.get(j,TransformsType_1.class,false);
            }
            return true;
        }
        return false;
