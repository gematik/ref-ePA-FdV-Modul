...
public class I_Authorization_Management_InsurantBinding
{
    ...
    public I_Authorization_Management_InsurantBinding(){}

    public I_Authorization_Management_InsurantBinding(String url)
    {
        this.url = url;
    }

    public I_Authorization_Management_InsurantBinding(String url,int timeOut)
    {
        this.url = url;
    ...
    public java.lang.Object DeleteAuthorizationKey(final RecordIdentifierType RecordIdentifier,final String ActorID,final String DeviceID ) throws java.lang.Exception
    {
        com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile __profile = new com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile();
        return (java.lang.Object)execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                __envelope.addMapping("http://ws.gematik.de/fd/phrs/AuthorizationService/v1.1","RecordIdentifier",new RecordIdentifierType().getClass());
                SoapObject __soapReq = new SoapObject("http://ws.gematik.de/fd/phrs/AuthorizationService/v1.1", "DeleteAuthorizationKey");
                __envelope.setOutputSoapObject(__soapReq);
                ...
                __info.name="ActorID";
                __info.type=PropertyInfo.STRING_CLASS;
                __info.setValue(ActorID);
                __soapReq.addProperty(__info);
                __info = new PropertyInfo();
                __info.namespace="http://ws.gematik.de/fd/phrs/AuthorizationService/v1.1";
                __info.name="DeviceID";
                __info.type=PropertyInfo.STRING_CLASS;
                __info.setValue(DeviceID);
                __soapReq.addProperty(__info);
                return __envelope;
            }
        ...
        },"http://ws.gematik.de/fd/phrs/AuthorizationService/v1.0#DeleteAuthorizationKey",__profile);
    }
    
    public java.lang.Object ReplaceAuthorizationKey(final AuthorizationKeyType AuthorizationKey,final RecordIdentifierType RecordIdentifier,final DeviceIdType DeviceID ) throws java.lang.Exception
    {
        com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile __profile = new com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile();
        return (java.lang.Object)execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://ws.gematik.de/fd/phrs/AuthorizationService/v1.1","RecordIdentifier",new RecordIdentifierType().getClass());
                __envelope.addMapping("http://ws.gematik.de/fd/phrs/AuthorizationService/v1.1","DeviceID",new DeviceIdType().getClass());
                SoapObject __soapReq = new SoapObject("http://ws.gematik.de/fd/phrs/AuthorizationService/v1.1", "ReplaceAuthorizationKey");
                __envelope.setOutputSoapObject(__soapReq);
        ...
        },"http://ws.gematik.de/fd/phrs/AuthorizationService/v1.0#ReplaceAuthorizationKey",__profile);
    }
    
    public GetAuditEventsResponse GetAuditEvents(final RecordIdentifierType RecordIdentifier,final DeviceIdType DeviceID ) throws java.lang.Exception
    {
        com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile __profile = new com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile();
        return (GetAuditEventsResponse)execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://ws.gematik.de/fd/phrs/AuthorizationService/v1.1","RecordIdentifier",new RecordIdentifierType().getClass());
                __envelope.addMapping("http://ws.gematik.de/fd/phrs/AuthorizationService/v1.1","DeviceID",new DeviceIdType().getClass());
                SoapObject __soapReq = new SoapObject("http://ws.gematik.de/fd/phrs/AuthorizationService/v1.1", "GetAuditEvents");
                __envelope.setOutputSoapObject(__soapReq);
        ...
        },"http://ws.gematik.de/fd/phrs/AuthorizationService/v1.0#GetAuditEvents",__profile);
    }
    
    public java.lang.Object PutNotificationInfo(final RecordIdentifierType RecordIdentifier,final DeviceIdType DeviceID,final String NewNotificationInfo ) throws java.lang.Exception
    {
        com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile __profile = new com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile();
        return (java.lang.Object)execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://ws.gematik.de/fd/phrs/AuthorizationService/v1.1","RecordIdentifier",new RecordIdentifierType().getClass());
                __envelope.addMapping("http://ws.gematik.de/fd/phrs/AuthorizationService/v1.1","DeviceID",new DeviceIdType().getClass());
                SoapObject __soapReq = new SoapObject("http://ws.gematik.de/fd/phrs/AuthorizationService/v1.1", "PutNotificationInfo");
                __envelope.setOutputSoapObject(__soapReq);
                ...
                __info = new PropertyInfo();
                __info.namespace="http://ws.gematik.de/fd/phrs/AuthorizationService/v1.1";
                __info.name="NewNotificationInfo";
                __info.type=PropertyInfo.STRING_CLASS;
                __info.setValue(NewNotificationInfo);
                __soapReq.addProperty(__info);
                return __envelope;
            }
        ...
        },"http://ws.gematik.de/fd/phrs/AuthorizationService/v1.0#PutNotificationInfo",__profile);
    }
